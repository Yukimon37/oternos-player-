...
constants.py
─────────────────────────────────────────────────────────────────────────────
OTERNOS PLAYER  —  Global constants, palette, fonts, animation utilities.
Nothing in here imports from other oternos modules.
─────────────────────────────────────────────────────────────────────────────
"""
...
# ─────────────────────────────────────────
#  EMBEDDED APP ICON  (hex-O emblem, 64×64 PNG, base64)
# ─────────────────────────────────────────
ICON_B64 = (
...
# Legacy underscore aliases — keep so existing call-sites don't break
_ease_out   = ease_out
_ease_in_out= ease_in_out
_lerp       = lerp
